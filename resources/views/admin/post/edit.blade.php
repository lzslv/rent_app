    ...
    <div class="ml-3 mr-3">
        ...
        <form action="{{ route('admin.post.update', $post )}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="landlord_email" class="form-control" id="landlord_email"
                       required value="{{ $post->landlord_email }}">
            </div>

            <div class="mb-3">
                <label for="landlord_phone" class="form-label">Телефон</label>
                <input type="tel" name="landlord_phone" class="form-control" id="landlord_phone"
                       required value="{{ $post->landlord_phone }}">
            </div>
